...
// and patches CheckboxGroup so users can show/hide "Binge" from Settings ->
...
(function () {
    ...
    function BingeNavButton() {
        return e(
            'div',
            { className: 'col-4 col-sm-3 col-md-2 col-lg-auto nav-link', id: 'binge-nav-container' },
            e(
                'a',
                {
                    href: REEL_PATH,
                ...
                e(
                    ...
                    e('path', { fill: 'currentColor', d: INFINITY_PATH })
                ),
                e('span', null, 'Binge')
            )
        );
