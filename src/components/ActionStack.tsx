    ...
    return (
        <div className="binge-action-rate-wrap">
            ...
            <button
                ...
                aria-label={
                    unavailable
                        ? t("action.rating_unavailable")
                        : ratingStars
                          ? t("action.rated_stars_tap_to_change", {
                                count: ratingStars,
                            })
                          : advanced
...
// Instagram-style comment-bubble outline. Name kept as `PencilIcon`
// for compatibility with existing call sites (Scribe button in the
// reel + feed); semantically it's now a comment glyph.
